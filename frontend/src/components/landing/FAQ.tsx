...
export function FAQ() {
  ...
  return (
    ...
    >
      {/* Background glow — same restrained visual language as Hero */}
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-0 text-center">
        ...
        <motion.h2
          ...
          className="max-w-[750px] text-[42px] font-extrabold leading-[0.95] tracking-[-0.04em] text-[#111217] sm:text-[56px] sm:leading-[0.94] lg:text-[64px] lg:leading-[0.92] lg:tracking-[-0.045em]"
        >
        ...
        <motion.div
          ...
          className="mx-auto mt-10 w-full max-w-[640px] divide-y divide-black/[0.08] border-y border-black/[0.08] text-left sm:mt-12 lg:mt-14"
        >
            ...
            return (
              ...
              >
                <button
                  ...
                  className="flex w-full items-center justify-between gap-4 py-4 text-left outline-none transition-colors sm:py-5"
                >
                  <span className="text-[13px] font-medium leading-[1.4] text-[#111217] sm:text-[14px]">
                    {item.question}
                  </span>
